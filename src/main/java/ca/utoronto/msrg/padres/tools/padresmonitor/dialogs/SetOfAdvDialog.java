 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SetOfAdvDialog extends MonitorDialog{
	...
	public SetOfAdvDialog(MonitorFrame owner, String brokerID, ClientMonitorCommandManager comm) {
		super(owner,MonitorResources.T_SET_ADV);
		
		m_brokerIDText.setText(brokerID);
		m_commManager = comm;
		m_commManager.sendGetMsgSetCommand(brokerID, ClientMonitorCommandManager.TYPE_ADV);
	...
	public int getCommandID() {
		...
		return MonitorResources.CMD_SET_ADV;
	}
	...
	public void notify(Object o) {
		...
		for (i = setMsg.iterator(); i.hasNext();) {
			AdvertisementMessage aMsg = (AdvertisementMessage) i.next();
			m_TextArea.append(aMsg.toString()+"\n");
		}
		setSize(640,480);
