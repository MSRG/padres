...
/**
* This dialog is a confirmation for the user when they want to resume a stopped broker.
*/
public class ResumeBrokerDialog extends MonitorDialog
{
    ...
    /**
    * Construct a resume broker dialog for the specified broker.
    * @param owner  Hook to MontiorFrame.
    * @param brokerID  The ID of the user selected broker.
    */
    public ResumeBrokerDialog(MonitorFrame owner, String brokerID) {
        super(owner, MonitorResources.T_RESUME_BROKER);
        m_BrokerID = brokerID;
    ...
    */
    public int getCommandID() {
        return MonitorResources.CMD_BROKER_RESUME;
    }
