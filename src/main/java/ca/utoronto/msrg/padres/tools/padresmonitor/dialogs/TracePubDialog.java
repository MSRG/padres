...
/**
 * This dialog lets the user enter the necessary parameters to trace a message
 * from the broker The connection is established through a single broker.
 */
public class TracePubDialog extends MonitorDialog {

	private static final long serialVersionUID = 1015831733238564602L;
	 ...
	 * 
	 * @param owner
	 *            Hook to MontiorFrame.
	 * @param brokerID
	 *            The ID of the user selected broker.
	 */
	public TracePubDialog(MonitorFrame owner, String brokerID) {
	...
	public void buildContentPanel() {
		JLabel traceLabel = new JLabel(MonitorResources.L_TRACE_MSG);
	...
	public int getCommandID() {
		return MonitorResources.CMD_TRACE_PUB_MESSAGE;
	}
