 ...
 * methods that wrap ReteRouter's main public methods to inform the
 * IBrokerTester object of occurrence of specific events within the object:
 * 
 *   - ReteRouter.handleMessage(*): IBrokerTester.routerHandlingMessage()
 *   is appropriately called.
 *   
 *   - ReteRouter.addSubWorkingMemory(): IBrokerTester.routerAddSubscription()
 *   is appropriately called.
 *   
 *   - ReteRouter.addAdvWorkingMemory(): IBrokerTester.routerAddAdvertisement()
 *   is appropriately called.
 * 
...
public class TesterReteRouter extends ReteRouter {
	...
	public TesterReteRouter(IBrokerTester brokerTester, BrokerCore broker) {
		super(broker);
