...
/**
* This dialog is a confirmation for the user when they want to shutdown a broker.
*/
public class ShutdownBrokerDialog extends MonitorDialog
{
    ...
    /**
    * Construct a shutdown broker dialog for the specified broker.
    * @param owner  Hook to MontiorFrame.
    * @param brokerID  The ID of the user selected broker.
    */
    public ShutdownBrokerDialog(MonitorFrame owner, String brokerID) {
        super(owner, MonitorResources.T_SHUTDOWN_BROKER);
        m_BrokerID = brokerID;
    ...
    */
    public int getCommandID() {
        return MonitorResources.CMD_BROKER_SHUTDOWN;
    }
